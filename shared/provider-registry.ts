...
export const PROVIDER_DEFINITIONS = [
  ...
  { type: 'zenllm', label: 'ZenLLM', defaultBaseUrl: 'https://api.zenllm.org/v1', protocol: 'openai-compatible', requiresCustomBaseUrl: false },
  { type: 'xai', label: 'xAI', defaultBaseUrl: 'https://api.x.ai/v1', protocol: 'openai-compatible', requiresCustomBaseUrl: false },
  { type: 'cerebras', label: 'Cerebras', defaultBaseUrl: 'https://api.cerebras.ai/v1', protocol: 'openai-compatible', requiresCustomBaseUrl: false },
  { type: 'fireworks', label: 'Fireworks AI', defaultBaseUrl: 'https://api.fireworks.ai/inference/v1', protocol: 'openai-compatible', requiresCustomBaseUrl: false },
  { type: 'siliconflow', label: 'SiliconFlow', defaultBaseUrl: 'https://api.siliconflow.com/v1', protocol: 'openai-compatible', requiresCustomBaseUrl: false },
