...
import { Bot, CheckCircle, Clipboard, Link2, Loader2, Plug, RefreshCw, Send, Shield, Trash2, Unplug, XCircle, type LucideIcon } from 'lucide-react'
...
export default function Integrations() {
  ...
  return <div className="p-6 max-w-6xl mx-auto">
    ...
    <div className="mt-8"><DisabledCard icon={Plug} name="MCP Servers" /></div>
  </div>
}
...
function DisabledCard({ icon: Icon, name }: { icon: LucideIcon; name: string }) {
